...
@section('content')
    <div id="department-create-form" class="content-block-wrapper">
        <div class="content-block-form">
            {!!Form::open(['action' => 'Home\DepartmentController@store'])!!}
                <div class="form-group">
                    <label for="department-name">Name</label>
                    <input type="text" name="name" class="form-control" id="department-name" placeholder="">
                </div>
                <div class="form-group">
                    <label for="department-display-name">Display Name</label>
                    <input type="text" name="display_name" class="form-control" id="department-display-name" placeholder="">
                </div>
                <div class="form-group">
                    <label for="department-description">Description</label>
                    <input type="text" name="description" class="form-control" id="department-description" placeholder="">
                </div>
                <div class="form-group">
